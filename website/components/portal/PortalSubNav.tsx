          ...
          {visibleItems.map((item) => {
            ...
            return (
              <Link
                key={item.key}
                href={fullHref}
                className={`flex items-center gap-[8px] py-[14px] font-[family-name:var(--font-roboto)] text-[14px] max-sm:text-[13px] whitespace-nowrap transition-colors border-b-2 ${
                  isActive
